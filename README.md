...
- **Achievement**: Improved operational efficiency and productivity.
...
- Participate in multiple **industry-academia cooperation projects** in the field of data analysis.
...
|        | 5   | [Correlation Study Based on Field Data Application](https://github.com/DS-Zheng/Resume/blob/main/images/correlation_study.png)              | Using **interpretable models** to enhance result interpretation ability.                                                     | Verified in **3 scenarios**                                                     | Data Engineer, Data Scientist                    |
...
**AUO 智慧製造中心**:
- **角色**: 開發和優化決策支援系統
- **重點**: 利用領域知識和數據分析技術提升良率和計算性能

#### Expertise & Achievements

- **專案概述**: 成功處理多個項目，創造高效、數據驅動的解決方案，節省大量工時
- **專案成就**: 提高運營效率和生產力
...
- 國立雲林科技大學工業工程與管理碩士，**GPA 4.0**
- 參與多個數據分析領域的**產學合作專案**

我的職業生涯反映了我對推動**智慧製造技術**的持續追求，並展現了我在創新和卓越方面的不懈努力。
...
- 2019年8月 – 2021年7月
- GPA: 4.0/4.0
- 論文: 基於R-tree與SPACE-MDL-LSTM提升大區域人流預測之效率

**工業工程與管理學士**
- 國立雲林科技大學
- 2015年9月 – 2019年6月
- 論文: 最佳化彈性生產流程之機台派工  (基因演算法)
...
- 2021年8月 - 至今
- **主要職責:**
  - 開發和優化TFT-LCD Array決策支援項目
  - 應用和改進機器學習算法
  - 改善生產流程、產品/設備的良率、效率和計算性能
  - 參與7項大型和中型項目，節省大量工時
...
- **項目亮點:**
  - **全國地址數據庫應用於空間抽樣**
    - 開發一個具有成本效益的學術調查研究系統
    - 創建了地址正規化模組並建立了全國地址屬性資料庫
    - 獲得2019年台灣地理資訊學會學術研討會最佳學生論文獎

## 項目

| 規模  | 編號 | 項目                                                       | 描述                                                                                     | 表現                                                                 | 角色                                             |
|--------|-----|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|--------------------------------------------------|
| Large  | 1   | [Yield-Capacity Decision Support System](https://github.com/DS-Zheng/Resume/blob/main/images/yield_capacity_system.png)                        | 通過**良率預測**和**產能分析**推薦機台**PM計劃**                | 模型**RMSE降低20%**，**準確率達80%**，每月節省**90小時**工時 | Project Owner, Data Engineer, Data Scientist, Front/Backend Engineer |
|        | 2   | [Golden Path - Optimal Machine Combination Path Recommendation](https://github.com/DS-Zheng/Resume/blob/main/images/golden_path_recommendation.png) | 推薦影響良率的**最佳和最劣路徑組合**                                     | 缺陷數量減少**1.43%**，產品良率提高**1.62%**，每月節省**60小時**工時，已在**4個廠域**導入 | Data Engineer, Front/Backend Engineer             |
|        | 3   | [Capacity Calculation Decision Support System](https://github.com/DS-Zheng/Resume/blob/main/images/capacity_calculation_system.png)                  | 自動檢查生產狀態以確保滿足**需求要求**                           | 導入**4個生產流程**，每天為製造人員節省**3小時**工時 | Data Engineer, Data Scientist                    |
| Medium | 4   | [Manufacturing Production Rule Decision Support System](https://github.com/DS-Zheng/Resume/blob/main/images/production_rule_system.png)         | 監控**生產條件**以觸發**決策支持規則**                            | 導入**4個廠域**，每月節省**300小時**工時                      | Project Owner, Data Engineer, Front/Backend Engineer |
|        | 5   | [Correlation Study Based on Field Data Application](https://github.com/DS-Zheng/Resume/blob/main/images/correlation_study.png)              | 使用**可解釋性模型**提升結果解釋能力                                                     | 已在**3個場景**驗證                                                     | Data Engineer, Data Scientist                    |
|        | 6   | [Optimization and Reconstruction of Key Factor System Modules](https://github.com/DS-Zheng/Resume/blob/main/images/key_factor_optimization.png)   | 通過**架構優化**提高計算速度                                  | 計算效率提高**80%**                                      | Data Engineer, Data Scientist                    |
|        | 7   | [Feasibility Study of LLM Model for Field Adaptive Monitoring](https://github.com/DS-Zheng/Resume/blob/main/images/llm_model_monitoring.png)   | 使用**LangChain**將**LLM模型**連接到數據庫，設計**Prompt**以進行**流程監控**         | 改進了**數據分析準確性**，提高了**決策**和**運營效率** | System Architect, Prompt Designer, Feasibility Analyst |
